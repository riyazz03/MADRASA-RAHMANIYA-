        ...
        <section className="home-landing-section">
            <div className="main-container home-hero-container">
                <h1 className='hero-content'>
                    In supporting <span className='is-light-italic'>our madrassa</span>,
                    <span className='is-black'> you're helping create a foundation of learning and light.</span>
                    May each gift you give be returned to you as a place in paradise.
                </h1>
            </div>

            <div className="hero-carousel-wrapper">
                <div className="hero-donate-now-button">
                    <a href="" onClick={handleScroll} className="donate-now-link">
                        <p className="donate-now-button-text">
                            Donate Now
                            <Image
